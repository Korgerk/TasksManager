...
public class TaskManager {
    ...
    private int nextID = 1; // для ID уников

    private int getNextID() { // след уник
        return nextID++;
    }
    ...
    public void deleteTasks() { // очистка задач
        tasks.clear();
    }

    public void deleteEpics() { // очистка эпиков
        epics.clear();
        subtasks.clear();
    }

    public void deleteSubtasks() { // очистка подзадач
        subtasks.clear();
    ...
    public void deleteTaskByID(int id) { // очистка определённых задач
        tasks.remove(id);
    }

    public void deleteEpicByID(int id) { // очистка определённых эпиков
    ...
    public void deleteSubtaskByID(int id) { // очистка определённых подзадач
    ...
    private void updateEpicStatus(Epic epic) { // обновление эпика, если все подзадачи выполнены
